...
const Services = () => {
    ...
    return (
        <div className=" h-auto gap-4 md:h-auto lg:h-screen flex flex-col  items-center justify-center p-4 bg-white" id='services'>
            <h1 className="heading">
                Services
            </h1>
            <div className="md:flex-col lg:flex lg:flex-row lg:h-[80%]   md:h-[80%]    flex-row items-center justify-center space-y-2 gap-4 w-full md:w-[90%] h-[20%]">
                {services.map((service, index) => (
                    <div
                        key={index}
                        className="left-column  translate-y-20 lg:h-full w-full md:w-full lg:w-[25%] h-full hover:w-[50%] bg-zinc-900 rounded-2xl transition-all duration-300 ease-in-out shadow-lg flex flex-col items-end justify-start p-6 cursor-pointer group relative overflow-hidden"
                    >
                        ...
                        <div className="relative z-10 w-full flex flex-col items-end">
                            ...
                            {/* Points Section */}
                            <div className="mt-8 w-[90%] md:w-[60%] opacity-100 translate-y-0 md:opacity-100 lg:opacity-0 md:translate-y-4 md:group-hover:opacity-100 md:group-hover:translate-y-0 transition-all duration-500 delay-100">
